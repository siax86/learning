 ...
 */
final class Version20220402132303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE material (id INT AUTO_INCREMENT NOT NULL, material_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_7CBE759574D6573C (material_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
